...
public class LOEVillagers {
    ...
    public static final VillagerProfession POSTMASTER = registerVillagerProfession("postmaster", new VillagerProfession(
            ...
            Int2ObjectMap.entry(3, LOETradeSets.POSTMASTER_LEVEL_3),
            Int2ObjectMap.entry(4, LOETradeSets.POSTMASTER_LEVEL_4),
            Int2ObjectMap.entry(5, LOETradeSets.POSTMASTER_LEVEL_5))));
